...
export default function ContactUs() {
  return (
    <section className="grid lg:grid-cols-[minmax(540px,_1fr)_1fr] py-16 lg:h-[480px] bg-primary md:rounded-lg overflow-hidden text-white px-6 md:px-16 lg:px-24 gap-12 md:gap-6 relative">
