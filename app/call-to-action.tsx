...
export default function CallToAction() {
  ...
  return (
    <div className="lg:h-[292px] bg-primary rounded-lg z-10 relative px-24 grid lg:grid-cols-2 gap-8 items-center text-white py-16 text-center lg:text-start overflow-hidden">
