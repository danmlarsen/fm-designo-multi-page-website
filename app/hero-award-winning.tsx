...
export default function HeroAwardWinning() {
  return (
    <section className="flex items-center px-24 bg-primary rounded-lg overflow-hidden lg:h-[640px] text-white relative pt-20 pb-96">
      ...
      <Image src={ImageHeroPhone} alt="Image of a mobile phone" className="absolute -bottom-96 lg:-bottom-60 right-4 w-[624px]" />
    </section>
  );
}
